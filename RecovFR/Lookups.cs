...
namespace RecovFR
{
    public static class Lookups
    {
        ...
        public static Dictionary<string, string> LookupPed = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            // { "0x9C9EFFD8", "mp_f_freemode_01" }, // Removed as cannot rebuild character
            ...
            // { "0x705E61F2", "mp_m_freemode_01" }, // Removed as cannot rebuild character
        ...
        public static Dictionary<string, string> LookupVehicles = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            // 11John11 LSPD Pack //
            { "0x52FEB505", "lspdb" },
            { "0x680BC338", "polalamoold" },
            { "0x826E135B", "poleveron" },
            { "0xDEAAD3F2", "police42old" },
            { "0x5C239DB6", "policeold" },
            { "0x0EB0FDF0", "policeslick" },
            { "0xC2515D0D", "polriot" },
            { "0x68F1A01E", "polsadlerk9" },
            { "0x36221E63", "polspeedo" },
            { "0x7080C516", "pscout" },
            { "0xAE26FCF3", "pscoutnew" },
            { "0xD8688940", "swatstalker" },
            // 11John11 LSSD Pack //
            { "0x1EF26D08", "sheriffoss" },
            { "0xB2A17974", "sherifffug" },
            { "0xD40D98D3", "sheriffalamo" },
            { "0xB3795B6D", "sheriffroamer" },
            { "0x3B414DD6", "sheriffstalker" },
            { "0x7CF476B4", "sheriffthrust" },
            { "0x98593958", "sheriffrumpo" },
            { "0xA3398C84", "sheriffcq4" },
            { "0x158A86DD", "sheriffscout" },
            { "0x8397EE8A", "sheriffscoutnew" },
            { "0x678761C2", "sheriffinsurgent" },
            // Bravo-One-Charlie SASP Ranger Pack // 
            { "0xCF7118F7", "Prangeryo" },
            { "0x3636514C", "Prangerlr" },
            { "0x489D332B", "Prangerstalker" },
            { "0xC8C9F0ED", "Prangeral" },
            { "0x6115381D", "Prangerme" },
            { "0x0E5F7B13", "Prangerbi" },
            { "0xB1F14238", "Prangerbu" },
            { "0x6DFE4A27", "Prangersd" },
            { "0x59C3A2AA", "Prangertor" },
            { "0x84CC4991", "Prangerstanier" },
            { "0x2D269C3F", "Prangersct" },
            { "0xAF9A3BD2", "Proutlaw" },
            { "0x9D283B3B", "Prangercara" },
            { "0x4287B800", "Prangereveron" },
            { "0x1F248D50", "Prangerverus" },
            { "0xF96FF66F", "Parkbf400" },
            { "0x4624C3CA", "Prangerlr2" },
            { "0x7B8F3AE9", "Prangerme2" },
            { "0x0D44101A", "Prangerstalker2" },
            { "0xD47FF830", "Prangeryo2" },
            { "0x70803032", "Prangeryo3" },
            { "0x8CF8B09F", "Prangerstanier2" },
            { "0xF762AC12", "Prangerpat" },
            { "0xB7F0DE87", "Prangersm" },
            { "0x6B10001D", "Prangersm2" },
            { "0x9AC15F7F", "Prangersm3" },
            { "0x6450957F", "Prangerlrold" },
            { "0xDFB04893", "Prangerplane" },
            { "0xFB010107", "Saspsteed" },
            { "0x746022B0", "Prangerbi2" },
            { "0x7D6EAB71", "Prangeryok9" },
            { "0x2762531D", "Prangerlrk9" },
            { "0x47685E76", "Prangeralk9" },
            { "0x942B1428", "Prangerfc" },
            { "0xCCE7098B", "Prangerri" },
            { "0x904331B5", "Prangerheli" },
            { "0x62C184FC", "Prangerpred" },
            { "0x57060DA1", "Parkstalker" },
            { "0xBA601796", "Parkbjxl" },
            { "0x9FC6881E", "Sasputil" },
            { "0xE6B931EA", "Saspevutil" },
