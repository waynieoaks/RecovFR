...
namespace RecovFR
{
    public static class Lookups
    {
        ...
        public static Dictionary<string, string> LookupVehicles = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            {"0x2280E396", "BCSO6"},
            {"0x8D61B95A", "BCSO7"},
            {"0x4F8593F5", "BCSOCYCLE"},
            {"0xBC8FD101", "BCSODIRTB"},
            {"0x487EC8CC", "BCSOMB"},
            {"0x38DEAB98", "BCSOK9"},
            {"0xF3420333", "BCSOASU"},
            {"0x1ECFD003", "BCSOSUPER"},
            {"0x003AFFD5", "BCSORIOT"},
            {"0x46D784B9", "CAYOPS"},
            {"0xCF037659", "CAYOPS2"},
            {"0xD8B3B774", "DPPD"},
            ...
            {"0x91093249", "LSPD4"},
            {"0x3F39920A", "LSPDCMD"},
            {"0x115E59FE", "LSPDCYCLE"},
            {"0x1AA0BC43", "LSPDDIRTB"},
            {"0x7DE8FDD5", "LSPDESU"},
            {"0xF7313AAF", "LSPDMB"},
            {"0xBECAF49D", "LSPDASU"},
            {"0x47773B6A", "LSPDK9"},
            {"0x86FEED0C", "LSPDPARKE"},
            {"0xBE1AC24F", "LSPDRIOT"},
            {"0x63768D17", "LSPDRIOT2"},
            {"0x033EC9F8", "LSPDSUPER"},
            {"0xD6B1B340", "LSPDTRAN"},
            {"0x2F0E31A7", "LSSD"},
            {"0x92230175", "LSSD2"},
            {"0x47C76CB7", "LSSD3"},
            {"0x3950CFCA", "LSSD4"},
            {"0xB4DE0BD0", "LSSDCYCLE"},
            {"0x68B07656", "LSSDDINGHY"},
            {"0x3D1A20FB", "LSSDDIRTB"},
            {"0x071AC811", "LSSDMB"},
            {"0xF0A86B8A", "LSSDASU"},
            {"0x021CC059", "LSSDK9"},
            {"0xE1DCBF59", "LSSDRIOT"},
            {"0x9088F856", "LSSDSUPER"},
            {"0x893D2872", "LSSDTRAN"},
            {"0x08DE2A8B", "NOOSE"},
            {"0x249BDA33", "NOOSE2"},
            {"0x1337B767", "NOOSE3"},
            {"0x3665158B", "NOOSETRU"},
            {"0xDFA697DB", "NOOSERIOT"},
            {"0x55F2D561", "NOOSEPIA"},
            {"0xB7FB4DA9", "NOOSEPIA2"},
            {"0x65818CC7", "NOOSEASU"},
            {"0xC12AFFD2", "SAHP"},
            {"0xE27D9118", "SAHP2"},
            {"0xD0CC6DBE", "SAHP3"},
            {"0xC0F7CE15", "SAHP4"},
            {"0x86F576DD", "SAHPCYCLE"},
            {"0x75653D83", "SAHPASU"},
            {"0xA69B03A4", "SAHPMB"},
            {"0xC344055B", "SAHPRIOT"},
            {"0xBCF14AF7", "SAPA"},
